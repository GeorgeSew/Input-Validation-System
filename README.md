...
3. Locate `Validation.java` in the Source Packages.
4. Right-click it and select **Run File** (or run the project's main class directly).
5. The Aracnid Validation System window will open. Fill in the fields — validation feedback appears live under each one.
